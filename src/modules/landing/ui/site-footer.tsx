      ...
      {logos.map((logo, i) => {
        ...
        return (
          <div
            ...
            className={
              tone === "dark"
                ? "flex h-40 w-72 shrink-0 items-center justify-center rounded-xl border border-line bg-ink-fixed p-6"
                : "group relative flex h-40 w-72 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-paper-fixed p-6 shadow-sm"
            }
          >
